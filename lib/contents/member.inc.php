...
?>    
	...
	?>
    <div class="loginInfo"><?php echo __('Please insert your member ID and password given by library system administrator. If you are library\'s member and don\'t have a password yet, please contact library staff.'); ?></div><br />
...
<?php
    ...
    // show all
        ...
        echo '<div class="panel-heading tagline">'.__('Member Detail').'</div>';
        echo '<div class="panel-body">'.showMemberDetail().'</div>';                        
        echo '</div>';

        echo '<div class="panel panel-default">';
        echo '<div class="panel-heading tagline">'.__('Your Current Loan').'</div>';
        echo '<div class="panel-body">'.showLoanList().'</div>';                        
        echo '</div>';

        echo '<div class="panel panel-default">';
        echo '<div class="panel-heading tagline">'.__('Your Title Basket').'</div>';
        echo '<div class="panel-body">'.showBasket().'</div>';                        
        echo '</div>';
        
        echo '<div class="panel panel-default">';
        echo '<div class="panel-heading tagline">'.__('Your Loan History').'</div>';
        echo '<div class="panel-body">'.showLoanHist().'</div>';                        
        echo '</div>';
        

        if ($sysconf['auth']['member']['method'] == 'native') {
        echo '<div class="panel panel-danger">';
        echo '<div class="panel-heading tagline">'.__('Change Password').'</div>';
        echo '<div class="panel-body">'.changePassword().'</div>';                        
        echo '</div>';
        }
