...
if (isset($_POST['doExport'])) {
    ...
    if (empty($_POST['fieldSep']) OR empty($_POST['fieldEnc'])) {
        ...
        $sql = "SELECT
            i.item_code, b.title, b.call_number, pbs.publisher_name, pl.place_name, b.publish_year, i.price
            FROM item AS i, biblio AS b
            LEFT JOIN mst_publisher AS pbs ON b.publisher_id = pbs.publisher_id            
