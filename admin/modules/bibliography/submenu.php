...
$menu[] = array(__('Item Barcodes Printing'), MWB.'bibliography/item_barcode_generator_plus.php', __('Print Item Barcodes'));
$menu[] = array(__('Catalog Printing'), MWB.'bibliography/printed_card_btu.php', __('Print Catalog Card'));
$menu[] = array(__('MARC Import'), MWB.'bibliography/marcimport.php', __('Import Bibliographic Data from MARC file'));
$menu[] = array(__('Data Export'), MWB.'bibliography/export1.php', __('Export Bibliographic Data To CSV format'));
$menu[] = array(__('Data Import'), MWB.'bibliography/import1.php', __('Import Data to Bibliographic Database from CSV file'));
$menu[] = array(__('Item Export'), MWB.'bibliography/item_export1.php', __('Export Item/Copies data To CSV format'));
$menu[] = array(__('Item Import'), MWB.'bibliography/item_import1.php', __('Import Data to Item/Copies database from CSV file'));
$menu[] = array('Header', __('Thu vien BTU'));
$menu[] = array(__('Data Import Plus'), MWB.'bibliography/import_plus1.php', __('Export Item/Copies data To CSV format'));
$menu[] = array(__('Export - Report'), MWB.'bibliography/export_report.php', __('Export Item/Copies data To CSV format'));
