...
$sysconf['mysqldump'] = '/var/www/vhosts/btu.edu.vn/httpdocs/thuvien/mysqldump';
...
$sysconf['currencies'] = array( array('0', 'NONE'), 'Rupiah', 'USD', 'Euro', 'DM', 'Pounds', 'Yen', 'Won', 'Yuan', 'SGD', 'Bath', 'Ruppee', 'Taka', 'VNĐ');

/* RESERVE PERIODE (In Days) */
$sysconf['reserve_expire_periode'] = 7;

/* CONTENT */
$sysconf['library_name'] = 'Thư viện';
$sysconf['library_subname'] = 'Trường Cao đẳng Cộng đồng Bình Thuận';
...
$sysconf['mail']['auth_username'] = 'duy13010@gmail.com'; // SMTP account username
$sysconf['mail']['auth_password'] = 'B@ochau89'; // SMTP account password
$sysconf['mail']['from'] = 'admin@localhost';
$sysconf['mail']['from_name'] = 'Thư viện BTU';
...
/* DATABASE RELATED */
if (!defined('DB_HOST')) { define('DB_HOST', '192.168.110.111'); }
